-- =============================================================================
--  VHDL instance generated by IPExpress    01/11/2021    16:07:53         
--  Filename: master_la0_inst.vhd                                          
...
PACKAGE master_la0_pkg IS
    COMPONENT master_la0
    PORT (
        clk:		IN std_logic;
        ...
        trigger_din_1:	IN std_logic_vector (4 downto 0);
        trigger_din_2:	IN std_logic_vector (0 downto 0);
        trigger_din_3:	IN std_logic_vector (0 downto 0);
        trigger_din_4:	IN std_logic_vector (7 downto 0);
        trace_din:	IN std_logic_vector (145 downto 0);
        ip_enable:	IN std_logic
    );

    END COMPONENT;

END PACKAGE master_la0_pkg;
